  ...
  <div class="pricing-row">
      ...
      <div class="feature-card">
        ...
        <div class="card-body">
          <ul>
            ...
            <li>Deploy Custom Libraries<sup>2</sup></li>
            <li></li>
          </ul>
        </div>
      </div>
    ...
    <div class="pricing-col">
      <div class="pricing-card card-free">
        <div class="card-header position-relative">
          <div>FREE</div>
          <div class="fs-6 text-muted">no account required</div>
    ...
    <div class="pricing-col">
      <div class="pricing-card card-standard">
        <div class="card-header position-relative">
          <div>Maker</div>
          <div class="fs-6 text-muted">5€ / month<sup>*</sup></div>
          <div class="text-muted fw-lighter card-price-annual">or 50€ / year<sup>*</sup></div>
          <span class="position-absolute top-0 translate-middle badge rounded-pill bg-warning pricing-badge">
            includes<br/>5€/month<br/>credit!<sup>1</sup>
          </span>
        </div>
        <div class="card-body">
          <ul>
            ...
            <li><span class="warn-icon"></span> 10 / month</li>
            <li><span class="warn-icon"></span> 10 / month</li>
            <li><span class="warn-icon"></span> 10 / month</li>
    ...
    <div class="pricing-col">
      <div class="pricing-card card-professional">
        <div class="card-header position-relative">
          ...
          <div class="fs-6 text-muted">15€ / month<sup>*</sup></div>
          <div class="text-muted fw-lighter card-price-annual">or 150€ / year<sup>*</sup></div>
          <span class="position-absolute top-0 translate-middle badge rounded-pill bg-warning pricing-badge">
            includes<br/>5€/month<br/>credit!<sup>1</sup>
          </span>
        </div>
        <div class="card-body">
          <ul>
            ...
            <li class="check-icon"></li>
            <li><span class="check-icon"></span></li>
            <li><span class="check-icon"></span> 50 / month</li>
            <li><span class="check-icon"></span> 50 / month</li>
            <li><span class="check-icon"></span> 50 / month</li>
            <li><span class="check-icon"></span> 150 / day</li>
            <li><span class="check-icon"></span></li>
            <li><span class="check-icon"></span></li>
    ...
    <div class="pricing-col">
      <div class="pricing-card card-enterprise">
        <div class="card-header">
          <div>Enterprise</div>
          <div class="fs-6 text-muted">49€ / month / user<sup>*</sup></div>
          <div class="text-muted fw-lighter card-price-annual">billed annually</div>
        </div>
        <div class="card-body">
          <ul>
            <li class="check-icon"></li>
            ...
            <li class="check-icon"></li>
            <li><span class="check-icon"></span></li>
            <li><span class="check-icon"></span> 100 / month / user</li>
            <li><span class="check-icon"></span> 100 / month / user</li>
            <li><span class="check-icon"></span> 100 / month / user</li>
