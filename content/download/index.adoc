...
[.small.text-muted]
_Digitally signed by Scheibling Consulting AB (sponsored by https://ossign.org/[OSSign])._

[.download-section.macos]
== {{< icon "fa-brands fa-apple" >}} macOS

_Requirements: macOS 10.14 or later_
...
_Important: *Set the executable flag* before starting the AppImage!
For details, or if it doesn't start,
https://librepcb.org/docs/installation/linux/[read this]._
