...
For clarity and fairness, we provide four predefined levels of sponsorships:
...
defined. But we will never provide less value than stated in the table.
...
* Even though we're not very active on social media, we have ca. 1,000
  YouTube views per month with
  https://www.youtube.com/@LibrePCB[ca. 450 subscribers],
  https://github.com/LibrePCB/LibrePCB[>2,600 stars on GitHub],
  https://twitter.com/librepcb[almost 800 followers on X] and
  https://fosstodon.org/@librepcb[over 400 followers on Mastodon]
