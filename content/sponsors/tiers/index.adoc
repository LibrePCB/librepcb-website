...
* Our link:https://snapcraft.io/librepcb/listing[Snap Package] for Linux is
  installed on 8,900 weekly active devices
* Our link:https://flathub.org/apps/org.librepcb.LibrePCB[Flatpak] for Linux is
  installed ca. 2,300 times per month
* Our releases from the website are downloaded ca. 4,000 times per month,
  up to 7,000 after a new version
* Our website has ca. 30,000 unique visitors per month, up to 60,000 after
  a release announcement
* Our API server gets requests from >7,000 unique devices every month
