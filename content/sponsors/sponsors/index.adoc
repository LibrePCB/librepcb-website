...
| image:/img/sponsor-pcbgogo.png[link="https://www.pcbgogo.com/promo/LibrePCB1"]
| https://www.pcbgogo.com/promo/LibrePCB1[PCBgogo] is a global PCB manufacturing
  and assembly service provider, offering fast, reliable PCB fabrication and
  PCBA solutions from prototype to mass production.
...
| image:/img/sponsor-ossign.png[link="https://ossign.org/"]
| https://ossign.org/[OSSign] provides free code-signing for open-source
  projects. Our official Windows- & MacOS ARM releases are digitally signed
...
== icon:clock-rotate-left[] Historic Funding
...
| Between 2023 and 2026, this project has been funded through the
  https://nlnet.nl/commonsfund/[NGI0 Commons]
