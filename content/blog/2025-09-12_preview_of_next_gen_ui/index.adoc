...
<div class="text-center my-3">
  ...
  <a class="btn btn-danger mx-1 my-1" role="button" href="{{< relref "contribute/donate/index.adoc" >}}" >
...
the LibrePCB project, any link:{{< relref "contribute/donate/index.adoc" >}}[donations]
