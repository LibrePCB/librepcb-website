...
It is understandable that people compare LibrePCB to other EDA tools,
especially EAGLE and KiCad. To help you deciding which EDA tool is best for
your needs, here a short overview about the differences between LibrePCB and
other EDA tools.
...
- The schematic- and board editors of EAGLE are currently more powerful
  (for example, LibrePCB does not yet support hierarchical sheets)
...
- No broken projects caused by updated or removed libraries -- LibrePCB projects
  are always
  link:{{< relref "features/file-format/index.adoc" >}}[self-contained] and
...
and thus lacks many features which would be useful to design complex PCBs.
...
you should definitively give LibrePCB a try. But if you want to design very
complex PCBs, with differential pairs, hierarchical sheets, or other advanced
features, LibrePCB may not (yet) be the tool you are looking for.
