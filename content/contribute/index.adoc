...
need to be considered. The changes also need to follow the general strategy
of the project. So please don't waste your time with implementing a huge
feature which might never be merged -- ask the lead developer first about
